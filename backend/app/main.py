...
async def create_ambulance(ambulance_request: AmbulanceRequest):
...
async def assign_driver_to_ambulance(assignment_request: AssignDriverRequest):
...
async def assign_ambulance_to_booking(assignment_request: AssignAmbulanceRequest):
